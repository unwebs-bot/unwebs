...
/**
 * 카카오톡 상담 채널 URL — 언웹스 채널 상담(채팅) 링크.
 *
 * 기본값은 운영 채널로 설정됨. 변경 시 상수 또는 필터 사용:
 *   define('UW_KAKAO_CONSULT_URL', 'https://pf.kakao.com/_xxxxx/chat');
...
{
    $url = defined('UW_KAKAO_CONSULT_URL') ? UW_KAKAO_CONSULT_URL : 'https://pf.kakao.com/_LhDcxj/chat';
